...
package com.example.montreuxclient.ntf.record;
...
public class UriRecord implements ParsedNdefRecord {
    ...
    public View getView(Activity activity, LayoutInflater inflater, ViewGroup parent, int offset) {
        ...
        String textMessage = mUri.toString();
        
        // Adapted especially for iTLV to extract URL query
        String urlQuery = mUri.getQuery();
        String[] urlTags = urlQuery.split("=");
        if( urlTags.length == 2) 
        	textMessage = urlTags[1];
