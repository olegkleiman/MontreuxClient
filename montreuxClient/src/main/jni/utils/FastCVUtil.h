...
//---------------------------------------------------------------------------
JNIEXPORT void JNICALL Java_com_example_montreuxclient_fastcv_FeatureDetection_utils_FastCVUtil_init
(
   JNIEnv* env,
   jobject obj
);
...
///
//------------------------------------------------------------------------------
JNIEXPORT void JNICALL Java_com_example_montreuxclient_fastcv_FeatureDetection_utils_FastCVUtil_cameraFrameTick
(
   JNIEnv*  env,
   jobject  obj
);
